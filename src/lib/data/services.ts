...
export const SERVICES_DATA: Service[] = [
  ...
  // ─── Predictive Analytics ─────────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: "What is the difference between predictive analytics and traditional BI reporting?", a: "Traditional BI (Tableau, Power BI) answers \"what happened and why\" using historical data — backwards-looking. Predictive analytics answers \"what will happen next\" using ML — forward-looking. Where a BI dashboard shows last quarter revenue by region, predictive analytics forecasts next quarter revenue by region with confidence intervals and identifies which customers are at risk of churning before they actually do. Both are valuable; the combination is most powerful." },
      { q: "How accurate can predictive analytics models be for UK businesses?", a: "Accuracy depends on data quality, historical pattern stability, and the inherent predictability of the outcome. Typical ranges: retail demand forecasting MAPE 6-12%, customer churn prediction AUC 0.80-0.92, credit default prediction Gini 0.45-0.65, equipment failure prediction precision 0.85+. We benchmark against your existing process (often gut feel or simple heuristics) to demonstrate measurable improvement, not just technical metrics." },
      { q: "Do we need a data warehouse before starting predictive analytics?", a: "Not necessarily. Many UK clients start predictive analytics from CSV exports, CRM data, and ERP reports without a formal data warehouse. A warehouse improves data pipeline reliability and reduces ongoing maintenance cost as you scale, but it is not a prerequisite for a first predictive model. Codeworth builds pragmatic data pipelines that deliver the first model fast, with architecture that grows into a proper data platform." },
      { q: "How does predictive analytics integrate with our existing tools?", a: "Predictions are delivered via REST API (most common — integrates with any system), batch CSV scored daily or weekly, direct database write, or embedded dashboard in Power BI or Tableau. We match the integration method to your team capabilities. A customer churn score in Salesforce CRM or HubSpot, a demand forecast in your ERP, or a fraud probability in your payment processing system — all standard integration patterns we have delivered." },
      { q: "What UK industries see the best ROI from predictive analytics?", a: "UK financial services (credit, fraud, AML) report 3-8x ROI. UK retail and e-commerce (demand forecasting, CLV, churn) report 4-12x. UK manufacturing (predictive maintenance, quality prediction) report 5-15x. UK healthcare (readmission, bed management, supply chain) report 3-6x. The highest ROI comes where the cost of the predicted event is large (machine breakdown, fraud loss, patient readmission) and intervention is possible before the event occurs." },
    ],
