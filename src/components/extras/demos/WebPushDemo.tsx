...
export function WebPushDemo({ isUk }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-neutral-200 bg-white p-6">
        <div className="flex items-start justify-between mb-5">
          ...
          {stage === "subscribed" && (
            <button
              onClick={reset}
              className="px-3 py-1.5 rounded-lg text-sm text-neutral-500 hover:text-neutral-900 transition-colors"
            >
              {isUk ? "Скинути" : "Reset"}
            </button>
          )}
      ...
      {stage === "permission" && (
        <div className="rounded-xl border border-neutral-300 bg-neutral-50 p-4 shadow-lg max-w-md mx-auto">
          ...
          <div className="flex gap-2 justify-end">
            <button
              ...
              className="px-4 py-2 rounded-lg border border-neutral-300 text-sm font-medium text-neutral-700 hover:bg-neutral-100 transition-colors flex items-center gap-1.5"
            >
      ...
      {showSample && stage === "subscribed" && (
        <div
          role="alert"
          className="max-w-md mx-auto rounded-xl border border-neutral-200 bg-white shadow-xl p-4 animate-in slide-in-from-top-4 fade-in duration-500"
        >
