          ...
          {(["grid", "carousel"] as const).map((l) => (
            <button
              ...
              className={`px-3 py-1 rounded-md text-sm font-medium transition-all capitalize ${
                layout === l ? "bg-white text-neutral-900 shadow-sm" : "text-neutral-500"
              }`}
            >
          ...
          >
            ...
            <div className="p-4 space-y-3">
              <div className="flex items-center gap-3">
                <button className="text-neutral-700 hover:text-rose-500"><Heart className="w-6 h-6" /></button>
                <button className="text-neutral-700 hover:text-neutral-900"><MessageCircle className="w-6 h-6" /></button>
                <button className="text-neutral-700 hover:text-neutral-900"><Bookmark className="w-6 h-6 ml-auto" /></button>
              </div>
            ...
            <button
              onClick={() => setOpenPost(null)}
              className="absolute top-4 right-4 w-9 h-9 rounded-full bg-white text-neutral-700 hover:bg-neutral-100 flex items-center justify-center"
