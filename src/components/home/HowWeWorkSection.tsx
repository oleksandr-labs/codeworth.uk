...
const STEPS_UK = [
  ...
  },
  {
    ...
    description: "Тренуємо та валідуємо моделі (XGBoost, transformers, LSTM, ensemble), порівнюємо підходи, обираємо найкращу архітектуру за вашими метриками.",
    duration: "2–6 тижнів",
...
const STEPS_EN = [
  ...
  },
  {
    ...
    description: "We train and validate models (XGBoost, transformers, LSTMs, ensembles), compare approaches and select the best architecture for your metrics.",
    duration: "2–6 weeks",
    color: "bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 border-blue-100 dark:border-blue-900",
  },
  {
