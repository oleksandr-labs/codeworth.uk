...
import { Home, Briefcase, BookOpen, Phone, FolderKanban } from "lucide-react";
...
export function BottomNav() {
  ...
  const NAV_ITEMS = [
    ...
    { path: "/services",   icon: Briefcase,     label: isUk ? "Послуги"    : "Services" },
    { path: "/portfolio",  icon: FolderKanban,  label: isUk ? "Портфоліо" : "Portfolio" },
