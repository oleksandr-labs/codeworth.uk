    ...
    <div className="font-sans">
      ...
      <nav className="flex items-center justify-between px-8 py-4 border-b border-gray-100">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-gray-900 text-sm">LaunchApp</span>
        </div>
      ...
      <div className="bg-gray-950 text-white px-8 py-6 text-center">
        <div className="text-xs text-gray-400 mb-3 uppercase tracking-widest">Launch countdown</div>
      ...
      <div className="px-8 py-8 bg-violet-50 text-center border-t border-violet-100">
        <div className="text-sm font-bold text-gray-900 mb-1">🎁 Move up the queue</div>
        <div className="text-xs text-gray-500 mb-3">Refer a friend → skip 10 spots in the waitlist</div>
        <div className="flex gap-2 max-w-xs mx-auto">
          <div className="flex-1 bg-white border border-gray-200 rounded-lg px-3 py-2 text-xs text-gray-500 truncate">
