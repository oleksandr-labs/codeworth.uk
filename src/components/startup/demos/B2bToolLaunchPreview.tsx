  ...
  return (
    <div className="font-sans">
      ...
      <section className="px-8 py-8 bg-gray-950 border-t border-gray-800">
        <div className="text-xs text-gray-500 mb-4">Works with your existing stack</div>
      ...
      <section className="px-8 py-10 bg-white">
        <h2 className="text-xl font-bold text-gray-900 text-center mb-6">Team-first pricing</h2>
        <div className="grid grid-cols-3 gap-4 max-w-3xl mx-auto">
          {[
            ...
            <div key={p.name} className={`rounded-xl p-5 border-2 ${p.popular ? "border-cyan-500 bg-cyan-50" : "border-gray-200 bg-white"}`}>
              ...
              <div className="flex items-end gap-1 my-2">
                ...
                <span className="text-xs text-gray-500 mb-0.5">{p.per}</span>
              </div>
