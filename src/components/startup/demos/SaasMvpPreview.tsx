export function SaasMvpPreview() {
  return (
    <div className="font-sans">
      ...
      <section className="px-8 py-12 bg-white">
        ...
        <div className="grid grid-cols-3 gap-4 max-w-3xl mx-auto">
          {[
            ...
            <div key={f.title} className="p-4 rounded-xl bg-gray-50 dark:bg-neutral-900 hover:bg-indigo-50 transition-colors">
        ...
        <div className="grid grid-cols-3 gap-4 max-w-3xl mx-auto">
          {[
            ...
            <div key={plan.name} className={`rounded-xl p-5 border-2 ${plan.color}`}>
              ...
              <div className="text-2xl font-extrabold text-gray-900 dark:text-white my-1">{plan.price}</div>
              <div className="text-xs text-gray-500 dark:text-neutral-400 mb-4">{plan.desc}</div>
              <ul className="space-y-1.5 text-xs text-gray-600 dark:text-neutral-300 mb-4">
      ...
      {/* Social proof */}
      <div className="px-8 py-6 bg-white dark:bg-neutral-800 border-t border-gray-100 dark:border-neutral-700 text-center">
        <div className="text-xs text-gray-500 dark:text-neutral-400 mb-3">Trusted by teams at</div>
