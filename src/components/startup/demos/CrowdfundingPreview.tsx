export function CrowdfundingPreview() {
  return (
    <div className="font-sans">
      <nav className="flex items-center justify-between px-8 py-4 bg-white dark:bg-neutral-800 border-b border-orange-100">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-gray-900 dark:text-white text-sm">FundFlow</span>
        </div>
      ...
      <section className="px-8 py-8 bg-white dark:bg-neutral-800 border-b border-gray-100">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="h-3 bg-gray-100 dark:bg-neutral-800 rounded-full overflow-hidden mb-4">
      ...
      <section className="px-8 py-10 bg-gray-50">
        <h2 className="text-xl font-bold text-gray-900 dark:text-white text-center mb-6">Choose your reward</h2>
        <div className="grid grid-cols-3 gap-4 max-w-3xl mx-auto">
          {[
            ...
            <div key={t.tier} className="rounded-xl border-2 border-gray-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 p-4 text-center">
              <div className="text-lg font-extrabold text-gray-900 dark:text-white mb-1">{t.price}</div>
              <div className="font-semibold text-gray-700 dark:text-neutral-300 text-sm mb-2">{t.tier}</div>
              <div className="text-xs text-gray-500 dark:text-neutral-400 mb-3">{t.desc}</div>
