...
const ML_PLANS_UK = [
  {
    name: "Data Readiness Audit",
    price: "£950",
    period: "разово",
    delivery: "1 тиждень",
    description: "Перш ніж інвестувати в ML — перевіримо, чи готові ваші дані та інфраструктура.",
    highlight: false,
    features: [
      { text: "Аудит якості та повноти даних", included: true },
      { text: "Оцінка feasibility ML-підходу", included: true },
      { text: "Звіт: ризики, прогалини, рекомендації", included: true },
      { text: "Orієнтовний ROI-розрахунок", included: true },
      { text: "1 навчена та оцінена ML-модель", included: false },
  ...
  {
    name: "LLM & RAG Quick Start",
    price: "від £3,200",
    period: "проєкт",
    delivery: "4–6 тижнів",
    description: "GPT-чатбот або RAG-система на ваших даних — від пілоту до робочого демо.",
    highlight: false,
    badge: "Новинка",
    features: [
      { text: "Аудит джерел даних для RAG", included: true },
      { text: "Vector DB + embedding pipeline", included: true },
      { text: "Fine-tuning або prompt engineering", included: true },
      { text: "Guardrails проти галюцинацій", included: true },
      { text: "Chat/API інтерфейс", included: true },
      { text: "MLOps моніторинг + виявлення drift", included: "partial" },
      { text: "Кастомні інтеграції (CRM/ERP тощо)", included: "partial" },
      { text: "Гарантійна підтримка 3 місяці", included: true },
    ],
    cta: "Обговорити RAG-проєкт",
  },
  {
    name: "Production ML",
    price: "від £4,500",
...
const ML_PLANS_EN = [
  {
    ...
    period: "one-off",
    delivery: "1 week",
    description: "Before investing in ML — check whether your data and infrastructure are ready.",
    highlight: false,
    features: [
      { text: "Data quality & completeness audit", included: true },
      { text: "ML approach feasibility assessment", included: true },
      { text: "Report: risks, gaps, recommendations", included: true },
      { text: "Rough ROI estimate", included: true },
      { text: "1 trained & evaluated ML model", included: false },
  ...
  },
  {
    ...
    period: "project",
    delivery: "4–6 weeks",
    description: "A GPT chatbot or RAG system on your own data — from pilot to working demo.",
    highlight: false,
    badge: "New",
    features: [
      { text: "Data source audit for RAG", included: true },
      { text: "Vector DB + embedding pipeline", included: true },
      { text: "Fine-tuning or prompt engineering", included: true },
      { text: "Guardrails against hallucinations", included: true },
      { text: "Chat/API interface", included: true },
      { text: "MLOps monitoring + drift detection", included: "partial" },
      { text: "Custom integrations (CRM/ERP/etc.)", included: "partial" },
      { text: "3-month warranty support", included: true },
    ],
    cta: "Discuss a RAG Project",
  },
  {
    name: "Production ML",
    price: "£4,500",
