    ...
    ? {
        ...
        fields: {
          ...
          LocalBusiness: [
            ...
            { key: "description", label: "Опис", ph: "ML/AI консалтинг для бізнесу" },
          ],
          Article: [
            { key: "title", label: "Заголовок статті", ph: "Як обрати ML-консалтинг" },
    ...
    : {
        ...
        fields: {
          Organization: [
            ...
            { key: "logo", label: "Logo URL", ph: "https://codeworth.uk/icon-512.png" },
            { key: "description", label: "Description", ph: "ML/AI consultancy for UK businesses..." },
          ],
          LocalBusiness: [
            { key: "name", label: "Business name", ph: "Codeworth" },
            { key: "url", label: "URL", ph: "https://codeworth.uk" },
            { key: "phone", label: "Phone", ph: "+44 20 1234 5678" },
            { key: "email", label: "Email", ph: "hello@codeworth.uk" },
