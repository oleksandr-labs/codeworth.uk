...
export default async function PricingPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const offersSchema = {
    ...
    offers: [
      {
        "@type": "Offer",
        name: isUk ? "Data Readiness Audit" : "Data Readiness Audit",
        description: isUk ? "Аудит готовності даних та інфраструктури до ML-проєкту за 1 тиждень" : "Data and infrastructure readiness audit for an ML project in 1 week",
        priceCurrency: "GBP",
        price: "950",
      ...
      },
      {
        ...
        description: isUk ? "GPT-чатбот або RAG-система на ваших даних за 4–6 тижнів" : "A GPT chatbot or RAG system on your own data in 4–6 weeks",
        priceCurrency: "GBP",
        price: "3200",
        priceValidUntil: "2026-12-31",
        availability: "https://schema.org/InStock",
