    ...
    <>
      ...
      <main className="pt-24 pb-20">
                    ...
                    <ul className="divide-y divide-gray-100">
                      {section.links.map((link) => (
                        <li key={link.href}>
                          ...
                          >
                            <ChevronRight className="w-4 h-4 mt-0.5 text-gray-400 group-hover:text-indigo-600 shrink-0 transition-colors" />
                            <div>
                      ...
                      <li key={niche.slug}>
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <span className="text-xs text-gray-400 ml-2">{niche.subtitle}</span>
                          </div>
        ...
        <section className="py-10">
          <Container>
            <div className="rounded-xl border border-gray-200 bg-gray-50 px-6 py-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <FileText className="w-6 h-6 text-gray-500 shrink-0" />
              <div>
