          ...
          <div className="flex-1 min-w-0">
              ...
              <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    {MOCK_ORDERS.slice(0, 2).map((o) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="font-medium text-gray-900 text-sm truncate">{o.product}</div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <button
                    ...
                    className="bg-white rounded-2xl border border-gray-100 p-5 flex items-center gap-4 hover:border-indigo-200 hover:shadow-sm transition-all text-left"
                  >
                    <div className="w-10 h-10 bg-green-100 rounded-xl flex items-center justify-center">
                      <Globe className="w-5 h-5 text-green-600" />
                    </div>
                    <div>
                      <div className="font-semibold text-gray-900 text-sm">{isUk ? "Мої сайти" : "My Sites"}</div>
                  ...
                  <Link
                    ...
                    className="bg-white rounded-2xl border border-gray-100 p-5 flex items-center gap-4 hover:border-indigo-200 hover:shadow-sm transition-all"
                  >
                    <div className="w-10 h-10 bg-indigo-100 rounded-xl flex items-center justify-center">
                      <ShoppingBag className="w-5 h-5 text-indigo-600" />
                    </div>
                    <div>
                      <div className="font-semibold text-gray-900 text-sm">{isUk ? "Каталог рішень" : "Solutions Catalog"}</div>
                            ...
                            <div className="mt-4 pt-4 border-t border-gray-50">
                              ...
                              <div className="space-y-2">
                                {MOCK_FILES[o.id].map((f) => (
                                  <div key={f.name} className="flex items-center justify-between py-2 px-3 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors">
                                    <div>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex gap-2 mt-4">
                            ...
                            <button className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg bg-gray-100 text-gray-600 hover:bg-gray-200 transition-colors">
            ...
            {tab === "support" && (
              <div className="space-y-6">
                ...
                <div className="grid sm:grid-cols-3 gap-4">
                  {[
                    ...
                    <a
                      key={c.title}
                      href={c.href}
                      className="bg-white rounded-2xl border border-gray-100 p-5 hover:border-indigo-200 hover:shadow-sm transition-all block"
                    >
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-6">
                  <h2 className="font-bold text-gray-900 mb-5">{isUk ? "Історія комунікації — Замовлення #CN-4821" : "Communication History — Order #CN-4821"}</h2>
                      ...
                      return (
                        <div key={msg.id} className={`flex gap-3 ${isClient ? "flex-row-reverse" : ""}`}>
                          ...
                          <div className={`max-w-[75%] ${isClient ? "items-end" : "items-start"} flex flex-col`}>
                            ...
                            <span className="text-xs text-gray-400 mt-1 px-1">{msg.date}</span>
                          </div>
                        </div>
                      );
                    })}
                ...
                {/* Support form */}
                <div className="bg-white rounded-2xl border border-gray-100 p-6">
                  <h2 className="font-bold text-gray-900 mb-5">{isUk ? "Нове звернення" : "New Request"}</h2>
                  <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1.5">
                        {isUk ? "Тема" : "Subject"}
                      </label>
                      <select className="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-300">
