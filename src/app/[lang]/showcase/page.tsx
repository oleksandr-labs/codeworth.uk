  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main id="main-content" className="flex-1">
        ...
        {/* ─── BUTTONS ─────────────────────────────────────────────── */}
        <section id="buttons" className="py-16 border-b border-neutral-100 scroll-mt-20">
          <Container>
            <h2 className="text-2xl font-heading font-extrabold text-neutral-900 mb-2">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 items-center">
                  ...
                  <button className="px-6 py-2.5 rounded-xl bg-neutral-100 text-neutral-700 text-sm font-semibold hover:bg-neutral-200 transition-colors">
        ...
        {/* ─── BADGES ─────────────────────────────────────────────── */}
        <section id="badges" className="py-16 bg-neutral-50 border-b border-neutral-100 scroll-mt-20">
          <Container>
            <h2 className="text-2xl font-heading font-extrabold text-neutral-900 mb-2">
            ...
            <div className="space-y-5">
              ...
              <div className="flex flex-wrap gap-2 items-center">
                {["Next.js", "TypeScript", "Tailwind CSS", "PostgreSQL", "Vercel", "OpenAI", "Telegram", "LiqPay"].map((tag) => (
                  <span key={tag} className="px-3 py-1 rounded-lg bg-white border border-neutral-200 text-neutral-600 text-xs font-medium hover:border-indigo-300 hover:text-indigo-600 transition-colors cursor-pointer">
                    {tag}
                  </span>
                ))}
              </div>
        ...
        {/* ─── CARDS ─────────────────────────────────────────────── */}
        <section id="cards" className="py-16 border-b border-neutral-100 scroll-mt-20">
          <Container>
            <h2 className="text-2xl font-heading font-extrabold text-neutral-900 mb-2">
              🃏 {isUk ? "Картки" : "Cards"}
            </h2>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              ...
              {/* Product card */}
              <div className="rounded-2xl border border-neutral-200 bg-white overflow-hidden hover:shadow-md transition-shadow">
                ...
                <div className="p-5">
                  ...
                  <h3 className="font-bold text-neutral-900 mb-1">{isUk ? "Bundle Builder" : "Bundle Builder"}</h3>
                  <p className="text-sm text-neutral-500 leading-relaxed">{isUk ? "Конструктор комплектів — збільшує середній чек на 20–30%." : "Bundle kit builder — increases average order value by 20–30%."}</p>
              ...
              {/* Testimonial card */}
              <div className="rounded-2xl border border-neutral-200 bg-white p-6 hover:shadow-md transition-shadow">
              ...
              <div className="rounded-2xl border border-neutral-200 bg-white p-6 hover:shadow-md transition-shadow">
                ...
                <p className="text-3xl font-extrabold text-neutral-900 mb-1">+186%</p>
                <p className="text-sm font-semibold text-neutral-700 mb-1">{isUk ? "Зріст органічного трафіку" : "Organic traffic growth"}</p>
        ...
        {/* ─── ALERTS ─────────────────────────────────────────────── */}
        <section id="alerts" className="py-16 bg-neutral-50 border-b border-neutral-100 scroll-mt-20">
          <Container>
            <h2 className="text-2xl font-heading font-extrabold text-neutral-900 mb-2">
        ...
        {/* ─── INPUTS ─────────────────────────────────────────────── */}
        <section id="inputs" className="py-16 border-b border-neutral-100 scroll-mt-20">
          <Container>
            <h2 className="text-2xl font-heading font-extrabold text-neutral-900 mb-2">
            ...
            <div className="grid sm:grid-cols-2 gap-6 max-w-2xl">
              <div className="space-y-1">
                ...
                <input type="text" placeholder={isUk ? "Введіть ваше ім'я" : "Enter your name"} className="w-full px-4 py-2.5 rounded-xl border border-neutral-300 bg-white text-neutral-900 text-sm placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" readOnly />
              </div>
              <div className="space-y-1">
                <label className="block text-sm font-semibold text-neutral-700">Email</label>
                <input type="email" placeholder="hello@company.com" className="w-full px-4 py-2.5 rounded-xl border border-neutral-300 bg-white text-neutral-900 text-sm placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" readOnly />
              </div>
              <div className="space-y-1">
                <label className="block text-sm font-semibold text-neutral-700">{isUk ? "Послуга" : "Service"}</label>
                <select className="w-full px-4 py-2.5 rounded-xl border border-neutral-300 bg-white text-neutral-900 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <input type="text" placeholder={isUk ? "Пошук..." : "Search..."} className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-neutral-300 bg-white text-neutral-900 text-sm placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-indigo-500" readOnly />
                ...
                {[
                  ...
                  <div key={i} className="flex items-center justify-between">
                    ...
                    <div className={`relative w-10 h-5.5 rounded-full transition-colors ${item.on ? "bg-indigo-600" : "bg-neutral-300"}`} style={{height: "22px"}}>
                      <div className={`absolute top-0.5 w-4 h-4 rounded-full bg-white shadow-sm transition-transform ${item.on ? "translate-x-5" : "translate-x-0.5"}`} />
                    </div>
                  </div>
                ))}
              </div>
        ...
        {/* ─── INTERACTIVE MODULES ──────────────────────────────────── */}
        <section id="interactive" className="py-16 bg-neutral-50 scroll-mt-20">
          <Container>
            <h2 className="text-2xl font-heading font-extrabold text-neutral-900 mb-2">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {interactiveExtras.map((extra) => (
                <div key={extra.id} className="flex flex-col p-5 rounded-2xl border border-neutral-200 bg-white hover:shadow-md transition-shadow">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-2xl">{extra.emoji}</span>
                    <div className="flex-1 min-w-0">
                      <h3 className="font-bold text-neutral-900 text-sm leading-snug truncate">{extra.title}</h3>
                      <p className="text-xs text-neutral-400">{extra.category}</p>
                    </div>
                  </div>
                  <p className="text-xs text-neutral-500 leading-relaxed mb-4 flex-1 line-clamp-2">
                    {extra.description}
                  </p>
                  <div className="flex gap-2 mt-auto">
                    ...
                    <Link
                      href={`/${lang}/extras`}
                      className="px-3 py-2 rounded-lg border border-neutral-200 text-neutral-500 text-xs font-semibold hover:border-neutral-300 transition-colors"
                    >
