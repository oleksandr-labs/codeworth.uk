              ...
              {isUk ? (
                <>
                  ...
                  <ol>
                    ...
                    <li>Виконавець виконує роботи відповідно до затвердженого Statement of Work (SOW) та строків</li>
                  ...
                  <ul>
                    ...
                    <li>Методи оплати: банківський переказ, Stripe</li>
                    <li>Етапи проєкту (Discovery, PoC, Production) виставляються окремими рахунками згідно з SOW</li>
                  </ul>
                  ...
                  <ul>
                    <li>
                      <strong>Кастомні ML-системи</strong> — після повної оплати всі права на розроблений
                      код, моделі та документацію переходять до Замовника
                    </li>
                    <li>
                      Виконавець залишає за собою права на перевикористовувані фреймворки, бібліотеки
                      та know-how, що не є специфічними для даних чи бізнесу Замовника
                    </li>
                    <li>
                    ...
                    <li>
                      Навчальні дані та власні датасети, надані Замовником, лишаються виключною
                      власністю Замовника
                    </li>
                  </ul>
                  ...
                  <ul>
                    <li>
                      Виконавець обробляє дані Замовника відповідно до UK GDPR і за потреби
                      виступає Обробником даних (Data Processor)
                    </li>
                    <li>Угода про обробку даних (DPA) надається за запитом</li>
                    <li>Дані Замовника не використовуються для навчання моделей інших клієнтів</li>
                    <li>Конфіденційність бізнес-даних забезпечується умовами NDA</li>
                  </ul>
                  <h2>7. Гарантія та підтримка</h2>
                  <ul>
                    <li>
                      <strong>Гарантійний термін</strong> — 90 днів після продакшн-деплою для виправлення
                      дефектів, допущених Виконавцем
                    </li>
                    <li>Погіршення продуктивності моделі через природний дрейф даних не вважається дефектом</li>
                    <li>Подальша MLOps-підтримка надається за окремою угодою-ретейнером</li>
                  </ul>
                  <h2>8. Повернення коштів</h2>
                  <ul>
                    <li><strong>До початку етапу Discovery</strong> — передоплата повертається у повному обсязі</li>
                    <li>
                      <strong>Під час PoC</strong> — повертається частина передоплати за мінусом
                      вартості вже виконаних робіт, за письмовою згодою
                    </li>
                    <li>
                      <strong>Після продакшн-деплою</strong> — повернення не здійснюється; MLOps-ретейнер
                      можна скасувати з попередженням за 30 днів
                    </li>
                  </ul>
                  <h2>9. Обмеження відповідальності</h2>
                  <p>Виконавець не несе відповідальності за збитки, що виникли внаслідок:</p>
                  <ul>
                    <li>Рішень Замовника, прийнятих на основі результатів ML-моделі</li>
                    <li>Продуктивності моделі на даних поза межами валідованого навчального розподілу</li>
                    <li>Регуляторної невідповідності, не розкритої на етапі Discovery</li>
                  ...
                  <p>
                    Ця Угода регулюється законодавством Англії та Уельсу. Спори вирішуються шляхом
                    переговорів, а за їх безрезультатності — у судах Англії та Уельсу.
                  </p>
