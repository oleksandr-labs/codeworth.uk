...
function CellValue({
  ...
  return <span className="text-sm text-neutral-700 leading-snug">{value}</span>;
}
          ...
          <Container>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="rounded-2xl bg-white border border-neutral-200 p-8">
                ...
                <p className="text-sm text-neutral-500 font-medium mb-5">{isUk ? data.taglineUk : data.taglineEn}</p>
                <ul className="space-y-3">
        ...
        <section className="py-16 bg-white">
          <Container>
            <div className="max-w-3xl mx-auto rounded-2xl border-2 border-indigo-100 bg-indigo-50/50 p-8">
              <h2 className="text-xl font-heading font-extrabold text-neutral-900 mb-4">
