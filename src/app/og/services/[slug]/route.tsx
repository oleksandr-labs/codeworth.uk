...
> = {
  ...
  nlp: {
    ...
    subtitle: "Text Classification · NER · Sentiment · RAG",
    chips: ["Transformers", "spaCy", "LangChain", "FastAPI"],
  ...
  cv: {
    ...
    subtitle: "Object Detection · OCR · Image Classification",
    chips: ["YOLOv8", "OpenCV", "PyTorch", "ONNX"],
  ...
  recommendation: {
    ...
    subtitle: "Collaborative Filtering · Content-based · Hybrid",
    chips: ["Matrix Factorization", "ALS", "LightFM", "A/B testing"],
  ...
  mlops: {
    ...
    subtitle: "Model Serving · Monitoring · Retraining · CI/CD",
    chips: ["MLflow", "Airflow", "Docker", "Kubernetes"],
