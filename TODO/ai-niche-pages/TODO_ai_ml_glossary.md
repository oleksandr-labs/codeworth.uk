...
**Поточний стан глосарію:** 450+ термінів, 7 категорій (оновлено 2026-06-24 після Sprint 9–13)
**Статус:** ✅ Три великі хвилі додавання завершено (Sprint 9–13). Додано 300+ ML/MLOps/AI термінів з UK regulatory context (FCA, NHS, UK GDPR).
